 ...
 * @param {string} props.type - Error type or code (permission_denied, device_not_found, etc.)
 * @param {string} props.details - Optional detailed error information
 * @param {Function} props.onRetry - Optional callback when user clicks retry

...
const VoiceChatRecorder = () => {
  ...
  return (
    <div className="voice-recorder mt-4 flex flex-col items-center">
      ...
      <div className="recording-status text-sm mt-2 text-center">
        {isProcessing ? (
          <span className="text-gray-500">Processing voice...</span>
        ) : isRecording ? (
          <span className="text-red-500">Recording...</span>
        ) : (
          <span className="text-gray-500">Press to speak</span>
        )}
      </div>

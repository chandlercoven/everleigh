...
/**
 * VoiceChatResponse - Component to display the user message and AI response
 * Handles message rendering, loading states, and conversation actions
 */
const VoiceChatResponse: React.FC = () => {
  ...
  const renderResponse = (text: string): React.ReactNode => {
  ...
  const viewConversationHistory = (): void => {
    if (conversationId) {
